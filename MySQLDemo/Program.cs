    ...
    namespace MySQLDemo {
        class BaseConnection {
            ...
            public BaseConnection( ) {
                ...
                User = "root";
                Password = "123456";
                ConnectionString = String.Format("server=localhost;port=3306;database={0};user={1};password={2};SslMode=none;CharSet=utf8" , Database , User , Password);
            }

            public static MySqlConnection GetInstance( ) {
                if ( conn == null ) {
                    conn = new MySqlConnection(new BaseConnection().ConnectionString);
                    conn.Open();
                }
                return conn;
            }
